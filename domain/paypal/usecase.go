...
func (uc UseCase) processPayment(eventType string, request *model.PayPalRequest, body []byte) error {
	switch eventType {
...
func (uc UseCase) saleProduct(request *model.PayPalRequest, body []byte) error {
	var err error
...
func (uc UseCase) saleSubscription(request *model.PayPalRequest, body []byte) error {
	var err error
...
func parsePayPalRequest(headers http.Header, body []byte) model.PayPalRequest {
	return model.PayPalRequest{
...
func validate(p *model.PayPalRequest) error {
